...
export const mockProjects: Project[] = [
  {
    ...
    longDescription: 'Architected the application using Clean Architecture and BLoC pattern, ensuring high scalability and maintainable code for future feature expansions. Engineered high-performance Native Modules to process AR and image data.',
  ...
  },
  {
    ...
    longDescription: 'Designed the system architecture and backend logic to facilitate seamless real-time communication between Vietnamese teams and Japanese BrSEs for 100+ internal users. Orchestrated complex data flows between Chatwork APIs and AI services, ensuring high translation accuracy and low latency.',
  ...
  },
  {
    ...
    longDescription: 'Implemented a secure Authentication and User Management system (OAuth), integrating multi-provider login via Facebook, Google, and Phone. Engineered the core data logic for Newsfeed and Real-time Messaging modules, ensuring low latency and high data consistency for a smooth user experience.',
  ...
  },
  {
    ...
    longDescription: 'Developed an attendance tracking system based on iBeacon and BLE proximity detection. Solved complex technical challenges regarding signal latency and distance calculation to ensure high accuracy and stability for real-time Check-in/Check-out operations.',
