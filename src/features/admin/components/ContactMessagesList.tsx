                    ...
                    <div className="flex items-start gap-3">
                        ...
                        <div className="flex-1 min-w-0">
                            <div className="flex items-center gap-2 mb-1">
                                <h3
                                    className={`text-base truncate ${shouldBold ? 'font-semibold text-gray-900' : 'font-normal text-gray-700'}`}
                                >
                                    {message.subject}
                                </h3>
                            </div>
                            <div
                                className={`flex items-center gap-2 text-xs ${shouldBold ? 'font-semibold text-gray-700' : 'text-gray-500'}`}
                            >
...
export const ContactMessagesList = () => {
    ...
    useEffect(() => {
        ...
        if (
            importantParam &&
            (importantParam === 'important' || importantParam === 'not-important')
        ) {
                                        ...
                                        <button
                                            ...
                                            onClick={async () => {
                                                ...
                                                if (idsArray.length > 0) {
                                                    if (
                                                        window.confirm(
                                                            `Are you sure you want to delete ${idsArray.length} message${idsArray.length > 1 ? 's' : ''}?`
                                                        )
                                                    ) {
