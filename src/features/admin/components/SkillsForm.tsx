                  ...
                  <div className="bg-gray-50 px-4 py-3 flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <button
                        ...
                        disabled={saving || categoryIndex === categories.length - 1}
                        className="p-2 text-gray-600 hover:text-gray-900 hover:bg-gray-100 rounded transition-colors disabled:opacity-30 disabled:cursor-not-allowed"
                        title="Move down"
                      >
                        <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <div className="p-4 space-y-4 border-t border-gray-200">
                          ...
                          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div>
                              ...
                              <input
                                type="number"
                                value={category.order ?? categoryIndex}
                                onChange={(e) => handleUpdateCategory(category.id, { order: parseInt(e.target.value) || 0 })}
                                min="0"
                                disabled={saving}
                                className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary focus:border-primary outline-none disabled:bg-gray-100 disabled:cursor-not-allowed"
                              />
                                ...
                                >
                                  <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                                    <div>
                                      ...
                                      <input
                                        type="text"
                                        value={skill.name}
                                        onChange={(e) => handleUpdateSkill(category.id, skill.id, { name: e.target.value })}
                                    ...
                                    <div>
                                      ...
                                      <select
                                        ...
                                        onChange={(e) => handleUpdateSkill(category.id, skill.id, { proficiency: e.target.value as Skill['proficiency'] })}
                                        disabled={saving}
                                        className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary focus:border-primary outline-none disabled:bg-white disabled:cursor-not-allowed"
                                      >
                                    ...
                                    <div>
                                      ...
                                      <input
                                        ...
                                        onChange={(e) => handleUpdateSkill(category.id, skill.id, { priority: parseInt(e.target.value) || 0 })}
                                        min="0"
                                        disabled={saving}
                                        className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary focus:border-primary outline-none disabled:bg-white disabled:cursor-not-allowed"
                                      />
                                  ...
                                  <div className="flex items-center justify-between pt-2 border-t border-gray-200">
                                    <div className="flex items-center gap-2">
                                      <button
                                        type="button"
                                        onClick={() => handleMoveSkillUp(category.id, skill.id)}
                                        disabled={saving || skillIndex === 0}
                                      ...
                                      <button
                                        type="button"
                                        onClick={() => handleMoveSkillDown(category.id, skill.id)}
                                        disabled={saving || skillIndex === category.skills.length - 1}
                                        className="p-1.5 text-gray-600 hover:text-gray-900 hover:bg-gray-200 rounded transition-colors disabled:opacity-30 disabled:cursor-not-allowed"
                                        title="Move down"
                                      >
                                        <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
