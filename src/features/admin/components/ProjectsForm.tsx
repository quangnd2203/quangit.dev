                                    ...
                                    <div className="bg-gray-50 px-4 py-3 flex items-center justify-between">
                                        ...
                                        <div className="flex items-center gap-2">
                                            ...
                                            <button
                                                ...
                                                disabled={
                                                    saving || projectIndex === projects.length - 1
                                                }
                                                className="p-2 text-gray-600 hover:text-gray-900 hover:bg-gray-100 rounded transition-colors disabled:opacity-30 disabled:cursor-not-allowed"
                                                title="Move down"
                                            >
                                                ...
                                                <div className="p-4 space-y-4 border-t border-gray-200">
                                                    ...
                                                    <div className="space-y-3 pt-4 border-t border-gray-200">
                                                        ...
                                                        {(!project.technologies ||
                                                            ...
                                                            <p className="text-sm text-gray-500 italic py-2">
                                                                No technologies yet. Click "Add
                                                                Technology" to add one.
                                                            </p>
                                                        )}
                                                    ...
                                                    <div className="space-y-3 pt-4 border-t border-gray-200">
                                                        ...
                                                        {(!project.images ||
                                                            ...
                                                            <p className="text-sm text-gray-500 italic py-2">
                                                                No images yet. Click "Add Image" to
                                                                add one.
                                                            </p>
                                                        )}
                                                                            ...
                                                                            <div>
                                                                                ...
                                                                                <input
                                                                                    ...
                                                                                    placeholder={
                                                                                        assetType ===
                                                                                        'video'
                                                                                            ? 'Paste Google Drive video link (e.g., https://drive.google.com/file/d/...)'
                                                    ...
                                                    <div className="space-y-3 pt-4 border-t border-gray-200">
                                                        <div className="flex items-center justify-between">
                                                            ...
                                                            <button
                                                                type="button"
                                                                onClick={() =>
                                                                    handleAddAchievement(project.id)
                                                                }
                                                                disabled={saving}
                                                                className="px-3 py-1.5 text-sm font-medium text-primary bg-primary/10 rounded-lg hover:bg-primary/20 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                                                            >
                                                        ...
                                                        {(!project.achievements ||
                                                            ...
                                                            <p className="text-sm text-gray-500 italic py-2">
                                                                No achievements yet. Click "Add
                                                                Achievement" to add one.
                                                            </p>
                                                        )}
                                                    ...
                                                    <div className="space-y-3 pt-4 border-t border-gray-200">
                                                        ...
                                                        {(!project.metrics ||
                                                            ...
                                                            <p className="text-sm text-gray-500 italic py-2">
                                                                No metrics yet. Click "Add Metric"
                                                                to add one.
                                                            </p>
                                                        )}
