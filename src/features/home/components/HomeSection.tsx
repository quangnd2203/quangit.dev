...
export const HomeSection = () => {
  ...
  if (loading) {
    return (
      <section id="home" className="min-h-[80vh] flex items-center justify-center bg-linear-to-br from-white via-blue-50/20 to-indigo-50/30 relative overflow-hidden">
  ...
  if (error || !personalInfo) {
    return (
      <section id="home" className="min-h-[80vh] flex items-center justify-center bg-linear-to-br from-white via-blue-50/20 to-indigo-50/30">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[3fr_1fr] gap-12 lg:gap-16 xl:gap-20 items-center">
          ...
          >
            ...
            >
              ...
              <motion.button
                variants={badgeVariants}
                onClick={() => window.open(personalInfo.resumeUrl || `https://${personalInfo.contact.website}`, '_blank')}
                className={cn(
                  'px-8 py-4 rounded-lg text-base font-semibold transition-all duration-300',
